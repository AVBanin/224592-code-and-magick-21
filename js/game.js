...
let getFireballSpeed = function (isLeftWind) {
  return isLeftWind ? 2 : 5;
};
...
let getWizardX = function (fieldSizeX) {
  return (fieldSizeX - wizardWidth) * 0.5;
};

let getWizardY = function (fieldSizeY) {
  return fieldSizeY / 3;
};
